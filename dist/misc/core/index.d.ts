export declare const core: {
    ...
    readonly "no-restricted-syntax": import("@typescript-eslint/utils/dist/ts-eslint/Rule").RuleModule<import("./no-restricted-syntax").MessageId, [Partial<import("./no-restricted-syntax").Options> & {}], import("@typescript-eslint/utils/dist/ts-eslint/Rule").RuleListener>;
    readonly "no-self-import": import("@typescript-eslint/utils/dist/ts-eslint/Rule").RuleModule<import("./no-self-import").MessageId, [object & {}], import("@typescript-eslint/utils/dist/ts-eslint/Rule").RuleListener>;
    readonly "no-sibling-import": import("@typescript-eslint/utils/dist/ts-eslint/Rule").RuleModule<import("./no-sibling-import").MessageId, [object & {
        readonly folders?: readonly Partial<import("./no-sibling-import").SubOptions & import("../../utils").SharedOptions2>[];
    }], import("@typescript-eslint/utils/dist/ts-eslint/Rule").RuleListener>;
